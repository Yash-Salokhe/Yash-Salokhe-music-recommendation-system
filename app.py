...
music_dict = pickle.load(open(r'C:\Users\Dell\OneDrive\Desktop\Music\musicrec.pkl','rb'))
music = pd.DataFrame(music_dict)

similarity = pickle.load(open(r'C:\Users\Dell\OneDrive\Desktop\Music\similarities.pkl','rb'))
